  ...
  <div class="p-4 bg-base-200 rounded-lg shadow-md">
    ...
    <div class="space-y-2 text-xs">
      <div class="p-2 bg-base-300 rounded">
        ...
        <!-- Carousel (only for Project 1 in this example) -->
        <div v-if="currentProject === 0" class="mt-3 carousel w-full rounded">
          <div id="slide1" class="carousel-item relative w-full">
            <img src="@/images/dashboard1.png" class="w-full" alt="Dashboard sample 1"/>
            <a href="#slide4" class="btn btn-circle absolute left-2 top-1/2">❮</a>
            <a href="#slide2" class="btn btn-circle absolute right-2 top-1/2">❯</a>
          </div>
          <div id="slide2" class="carousel-item relative w-full">
            <img src="@/images/dashboard2.png" class="w-full" alt="Dashboard sample 2"/>
            <a href="#slide1" class="btn btn-circle absolute left-2 top-1/2">❮</a>
            <a href="#slide3" class="btn btn-circle absolute right-2 top-1/2">❯</a>
          </div>
          <div id="slide3" class="carousel-item relative w-full">
            <img src="@/images/dashboard3.png" class="w-full" alt="Dashboard sample 3"/>
            <a href="#slide2" class="btn btn-circle absolute left-2 top-1/2">❮</a>
            <a href="#slide4" class="btn btn-circle absolute right-2 top-1/2">❯</a>
          </div>
          <div id="slide4" class="carousel-item relative w-full">
            <img src="@/images/dashboard4.png" class="w-full" alt="Dashboard sample 4"/>
            <a href="#slide3" class="btn btn-circle absolute left-2 top-1/2">❮</a>
            <a href="#slide1" class="btn btn-circle absolute right-2 top-1/2">❯</a>
          </div>
        </div>

        <!-- Project 1 -->
        <div v-if="currentProject === 0">
          <h3 class="font-semibold">XMP Filter Storage</h3>
          <p>A secure web app for freelance photo editors to strictly manage and track XMP files. 
          Includes role-based dashboards, Editors Log, tutorials per role, ranking system, notifications, announcements, 
          profile picture upload, and strict XMP file storage.</p>
           <!-- Tech Stack with SVG icons -->
          <p class="mt-2 font-semibold">Tech Stack:</p>
          <div class="flex items-center gap-3 mt-1">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 256 256">
                ...
                <path stroke="#fff" stroke-linecap="round" stroke-linejoin="bevel" stroke-width="5.034" d="M181.613 144.664s1.407 6.891 21.797 2.686c8.909-1.842 3.544 5.161-5.484 9.352c-7.411 3.445-24.033 4.324-24.307-.422c-.703-12.27 8.747-8.543 8.065-11.616c-.619-2.77-4.852-5.484-7.636-12.262c-2.44-5.907-33.469-51.258 8.606-44.53c1.547-.316-10.969-40.077-50.344-40.654s-38.13 48.41-38.13 48.41"/>
                <path stroke="#fff" stroke-linejoin="round" stroke-width="5.034" d="M117.08 148.869c-5.484 6.131-3.867 7.207-14.835 9.464c-11.096 2.285-4.57 6.356-.324 7.425c5.161 1.294 17.1 3.122 25.172-8.178c2.461-3.445-.014-8.929-3.389-10.321c-1.631-.675-3.811-1.519-6.609 1.617z"/>
                <path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="5.034" d="M116.722 148.763c-.563-3.607 1.181-7.889 3.044-12.909c2.799-7.523 9.254-15.047 4.093-38.932c-3.846-17.79-29.672-3.706-29.672-1.294s1.167 12.235-.422 23.66c-2.088 14.921 9.492 27.535 22.823 26.248"/>
                <path fill="#fff" stroke="#fff" stroke-width="1.68" d="M110.577 95.27c-.12.822 1.511 3.023 3.628 3.318c2.116.296 3.923-1.42 4.043-2.25c.119-.83-1.512-1.73-3.628-2.025s-3.938.14-4.043.956Z"/>
                <path fill="#fff" stroke="#fff" stroke-width="0.837" d="M175.011 93.59c.112.822-1.512 3.022-3.628 3.318c-2.117.295-3.938-1.42-4.043-2.25c-.106-.83 1.512-1.73 3.628-2.025s3.937.14 4.043.956Z"/>
        ...
        <!-- Project 2 -->
        <div v-if="currentProject === 1" class="p-2 bg-base-300 rounded">
        <!-- Single image -->
        <div class="mt-3 w-full rounded">
            <img src="@/images/dashboard1.png" class="w-full" alt="Chatbot project sample"/>
        </div>

        <h3 class="font-semibold mt-2">🤖 Portfolio Chatbot AI (portfolio_chatbot_backend)</h3>
        <p>
            A Django REST Framework backend that combines a knowledge base with Gemini AI 
            to deliver polished, context-aware chatbot replies. Supports English, Tagalog, and Bisaya.
        </p>

        <!-- Tech Stack -->
        <p class="mt-2 font-semibold">Tech Stack:</p>
        <p>Django REST Framework, PostgreSQL, Gemini AI, Docker</p>

        <!-- Links -->
        <p class="mt-3">
            🔗 <a href="https://github.com/iamkentuckyjoles/portfolio_chatbot_backend" target="_blank" class="text-blue-600 underline">
            View on GitHub
            </a>
        </p>
        </div>
        ...
        <div v-if="currentProject === 2">
          ...
          <p>Third project description here.</p>
        </div>
      </div>
    </div>
  </div>
