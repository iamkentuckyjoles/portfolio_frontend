  ...
  <div class="bg-base-300 rounded text-xs">
   ...
   <!-- Project details -->
    ...
    <p class="text-justify">
      A secure web application for managers to oversee photo editors and clippers, featuring role‑based dashboards, activity tracking, event and XMP file management, editors and clippers log, ranking system and automatic calculation of rendered hours and activity.
    </p>
    <!-- Tech Stack -->
    <p class="mt-2 font-semibold">Tech Stack Used:</p>
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 mt-1">
        ...
        <div class="flex items-center justify-center gap-1">
          ...
          <span class="text-xs">Postgres</span>
        </div>
        ...
        <div class="flex items-center justify-center gap-1">
          ...
          <span class="text-xs">DigitalOcean</span>
        </div>
      </div>
...
const slides = [
  ...
  // Admin series
  { src: new URL('@/images/admin.png', import.meta.url).href, alt: 'Admin sample' },
  { src: new URL('@/images/admin5.png', import.meta.url).href, alt: 'Admin sample 5' },
  { src: new URL('@/images/admin8.png', import.meta.url).href, alt: 'Admin sample 8' },
  { src: new URL('@/images/admin9.png', import.meta.url).href, alt: 'Admin sample 9' },
  { src: new URL('@/images/admin12.png', import.meta.url).href, alt: 'Admin sample 12' },
  { src: new URL('@/images/admin14.png', import.meta.url).href, alt: 'Admin sample 14' },
  { src: new URL('@/images/admin17.png', import.meta.url).href, alt: 'Admin sample 17' },
  // Senior series
  { src: new URL('@/images/senior.png', import.meta.url).href, alt: 'Senior sample' },
  { src: new URL('@/images/senior1.png', import.meta.url).href, alt: 'Senior sample 1' },
  { src: new URL('@/images/senior2.png', import.meta.url).href, alt: 'Senior sample 2' },
  { src: new URL('@/images/senior4.png', import.meta.url).href, alt: 'Senior sample 4' },

  // Junior series
  { src: new URL('@/images/junior.png', import.meta.url).href, alt: 'Junior sample' },
  { src: new URL('@/images/junior1.png', import.meta.url).href, alt: 'Junior sample 1' },
  { src: new URL('@/images/junior2.png', import.meta.url).href, alt: 'Junior sample 2' },
  { src: new URL('@/images/junior4.png', import.meta.url).href, alt: 'Junior sample 4' },
  // Clipper series
  { src: new URL('@/images/clipper.png', import.meta.url).href, alt: 'Clipper sample' },
  { src: new URL('@/images/clipper1.png', import.meta.url).href, alt: 'Clipper sample 1' },
  { src: new URL('@/images/clipper2.png', import.meta.url).href, alt: 'Clipper sample 2' },
]
